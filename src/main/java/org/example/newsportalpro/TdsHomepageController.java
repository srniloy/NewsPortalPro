...
public class TdsHomepageController implements Initializable {
    ...
    @FXML
    void entertainButtonAction(ActionEvent event) {
        try {
            ...
            ArrayList<Article> articlesArray = (ArrayList<Article>) hm.get("thedailystar_articles");
    ...
    @FXML
    void sportsButtonAction(ActionEvent event){
        try {
            FileInputStream fis = new FileInputStream(articleDbPath);
            ObjectInputStream ois = new ObjectInputStream(fis);
            HashMap<String, ArrayList<Article>> hm = (HashMap<String, ArrayList<Article>>) ois.readObject();
            ...
            for (int i = 0; i < articlesArray.size(); i++) {
                ...
                if(articlesArray.get(i).newsType.equals("Sports")){
                    switch (j) {
                        case 0:
                            newsPane1.setVisible(true);
                            title1.setText(articlesArray.get(i).title);
    ...
    @FXML
    void businessButtonAction(ActionEvent event) {
        try {
            FileInputStream fis = new FileInputStream(articleDbPath);
            ObjectInputStream ois = new ObjectInputStream(fis);
            HashMap<String, ArrayList<Article>> hm = (HashMap<String, ArrayList<Article>>) ois.readObject();
            ...
            for (int i = 0; i < articlesArray.size(); i++) {
                ...
                if(articlesArray.get(i).newsType.equals("Business")){
                    switch (j) {
                        case 0:
                            newsPane1.setVisible(true);
                            title1.setText(articlesArray.get(i).title);
