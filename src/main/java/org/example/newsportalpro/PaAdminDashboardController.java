...
public class PaAdminDashboardController implements Initializable{
    ...
    void publishbtn(ActionEvent event) {
        ...
        if(f.length() == 0){
            ...
            hm.put("prothomalo_articles", articlesArray);
            ...
            try {
                ...
                ArrayList<Article> articlesArray = hm.get("prothomalo_articles");
